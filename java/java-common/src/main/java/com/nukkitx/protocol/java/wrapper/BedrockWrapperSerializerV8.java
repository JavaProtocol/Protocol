...
public class BedrockWrapperSerializerV8 extends BedrockWrapperSerializer {
    ...
    @Override
    public void serialize(ByteBuf buffer, JavaPacketCodec codec, Collection<BedrockPacket> packets, int level) {
    ...
    @Override
    public void deserialize(ByteBuf compressed, JavaPacketCodec codec, Collection<BedrockPacket> packets) {
