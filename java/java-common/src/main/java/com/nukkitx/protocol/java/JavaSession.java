...
import com.nukkitx.protocol.java.annotation.NoEncryption;
import com.nukkitx.protocol.java.compat.BedrockCompat;
import com.nukkitx.protocol.java.exception.PacketSerializeException;
import com.nukkitx.protocol.java.handler.BatchHandler;
import com.nukkitx.protocol.bedrock.handler.BedrockPacketHandler;
import com.nukkitx.protocol.java.handler.DefaultBatchHandler;
...
public abstract class JavaSession implements MinecraftSession<BedrockPacket> {
    ...
    private JavaPacketCodec packetCodec = BedrockCompat.COMPAT_CODEC;
    ...
    JavaSession(SessionConnection<ByteBuf> connection, EventLoop eventLoop, BedrockWrapperSerializer serializer) {
    ...
    public JavaPacketCodec getPacketCodec() {
